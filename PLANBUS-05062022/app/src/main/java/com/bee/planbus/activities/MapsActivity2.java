...
import com.bee.planbus.databinding.ActivityMaps2Binding;
...
public class MapsActivity2 extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("com.bee.planbus", MODE_PRIVATE);
        info = false;

        db = Room.databaseBuilder(MapsActivity2.this, PlaceDatabase.class, "Places").build();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (intentBilgi != null && intentBilgi.equals("new")) {
    ...
    private void registerLauncher() {
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if (result) {
                    //izin verildi
                    if (ContextCompat.checkSelfPermission(MapsActivity2.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(MapsActivity2.this, "Harita için izin gerekli!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void saveButton(View view) {
        ...
        compositeDisposable.add(placeDao.insert(place)
                ...
                .subscribe(MapsActivity2.this::handleResponse)
        );

    }

    public void handleResponse() {
        Intent intent = new Intent(MapsActivity2.this, MapListActivity.class);
